!function (t, e) {
    ...
    return function () {
        ...
        var t = {
            7621: function (t, e, s) {
                var i = s(8081), o = s.n(i), a = s(3645), n = s.n(a), l = s(1667), r = s.n(l),
                    c = new URL(s(6468), s.b), u = n()(o()), d = r()(c);
                ...
                function i(t, i) {
                    for (var a = {}, n = [], l = 0; l < t.length; l++) {
                        var r = t[l], c = i.base ? r[0] + i.base : r[0], u = a[c] || 0, d = "".concat(c, " ").concat(u);
                        a[c] = u + 1;
        ...
        return function () {
            ...
            var t = s(3379), e = s.n(t), o = s(7795), a = s.n(o), n = s(569), l = s.n(n), r = s(3565), c = s.n(r),
            ...
            var x = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
                w = ["light", "dark"], S = document.documentElement.classList,
                z = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
                F = S.contains("dark-style") ? "dark" : "light",
                k = "rtl" === document.documentElement.getAttribute("dir"), C = !!S.contains("layout-menu-collapsed"),
                A = !!S.contains("layout-menu-flipped"), T = !!S.contains("layout-navbar-fixed"),
                ...
                L = function () {
                    function t(e) {
                        var s = e.cssPath, i = e.themesPath, o = e.cssFilenamePattern, a = e.displayCustomizer,
                            ...
                            g = e.defaultTheme, v = e.pathResolver, b = e.onSettingsChange, _ = e.lang;
                        if (function (t, e) {
                    ...
                    }], s && b(e.prototype, s), Object.defineProperty(e, "prototype", {writable: !1}), t
                }();
            L.THEMES = [{name: "theme-default", title: "Default"}, {
                name: "theme-semi-dark",
                title: "Semi Dark"
            }, {name: "theme-bordered", title: "Bordered"}], L.LANGUAGES = {
                en: {
