...
//         var e, t, n = {
//             4098: function (e, t) {
//                 var n = "undefined" != typeof self ? self : this, o = function () {
//                     function e() {
...
//                         }
//
//                         x.polyfill = !0, e.fetch || (e.fetch = x, e.Headers = p, e.Request = b, e.Response = O), t.Headers = p, t.Request = b, t.Response = O, t.fetch = x, Object.defineProperty(t, "__esModule", {value: !0})
//                     }({})
...
//                         return new e(this.logger, g(g({}, {prefix: "".concat(this.prefix, ":").concat(t, ":")}), this.options))
//                     }
//                 }, {
...
//                             r = t.ns || this.options.defaultNS || [], i = n && e.indexOf(n) > -1,
...
//                     }
//                 }, {
//                     key: "translate", value: function (t, n, o) {
//                         var r = this;
...
//                             s = this.extractFromKey(t[t.length - 1], n), c = s.key, l = s.namespaces,
//                             f = l[l.length - 1], p = n.lng || this.language,
...
//                         }
//                         var g = this.resolve(t, n), y = g && g.res, v = g && g.usedKey || c,
//                             m = g && g.exactUsedKey || c, b = Object.prototype.toString.apply(y),
...
//                                 var S = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(v, y, B(B({}, n), {}, {ns: l})) : "key '".concat(c, " (").concat(this.language, ")' returned an object instead of string.");
//                                 return i ? (g.res = S, g) : S
//                             }
//                             if (a) {
//                                 var j = "[object Array]" === b, P = j ? [] : {}, L = j ? m : v;
//                                 for (var R in y) if (Object.prototype.hasOwnProperty.call(y, R)) {
...
//                                 y = P
//                             }
//                         } else if (k && "string" == typeof O && "[object Array]" === b) (y = y.join(O)) && (y = this.extendTranslation(y, t, n, o)); else {
//                             var C = !1, N = !1, T = void 0 !== n.count && "string" != typeof n.count,
//                                 D = u.hasDefaultValue(n), A = T ? this.pluralResolver.getSuffix(p, n.count, n) : "",
...
//                                 U = F && N ? void 0 : y, _ = D && I !== y && this.options.updateMissing;
//                             if (N || C || _) {
//                                 if (this.logger.log(_ ? "updateKey" : "missingKey", p, f, c, _ ? I : y), a) {
//                                     var M = this.resolve(c, B(B({}, n), {}, {keySeparator: !1}));
...
//                                 if ("fallback" === this.options.saveMissingTo && q && q[0]) for (var V = 0; V < q.length; V++) H.push(q[V]); else "all" === this.options.saveMissingTo ? H = this.languageUtils.toResolveHierarchy(n.lng || this.language) : H.push(n.lng || this.language);
...
//                     }
//                 }, {
//                     key: "extendTranslation", value: function (e, t, n, o, r) {
//                         var i = this;
//                         if (this.i18nFormat && this.i18nFormat.parse) e = this.i18nFormat.parse(e, B(B({}, this.options.interpolation.defaultVariables), n), o.usedLng, o.usedNS, o.usedKey, {resolved: o}); else if (!n.skipInterpolation) {
...
//                         }
//                         var f = n.postProcess || this.options.postProcess, p = "string" == typeof f ? [f] : f;
//                         return null != e && p && p.length && !1 !== n.applyPostProcessor && (e = U.handle(p, e, t, this.options && this.options.postProcessPassResolved ? B({i18nResolved: o}, n) : n, this)), e
//                     }
//                 }, {
...
//                                 var u = a.extractFromKey(e, s), c = u.key;
//                                 n = c;
//                                 var l = u.namespaces;
...
//                 }
//             }, J = ["v1", "v2", "v3"], X = {zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5};
//
//             function $() {
//                 var e = {};
...
//                         var n = this, o = e.noAbs ? e.plurals(t) : e.plurals(Math.abs(t)), r = e.numbers[o];
...
//                                 var r = P(t, u, e);
//                                 return s.alwaysFormat ? s.format(r, void 0, n, Y(Y(Y({}, o), t), {}, {interpolationkey: e})) : r
//                             }
//                             var i = e.split(s.formatSeparator), a = i.shift().trim(),
//                                 c = i.join(s.formatSeparator).trim();
//                             return s.format(P(t, u, a), c, n, Y(Y(Y({}, o), t), {}, {interpolationkey: a}))
//                         };
//                         this.resetRegExp();
...
//                                 var n = r[1].trim();
//                                 if (void 0 === (i = l(n))) if ("function" == typeof f) {
//                                     var u = f(e, r, o);
//                                     i = "string" == typeof u ? u : ""
//                                 } else if (o && o.hasOwnProperty(n)) i = ""; else {
//                                     if (p) {
//                                         i = r[0];
//                                         continue
//                                     }
...
//                         var n, o, r = this, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
//                             a = Y({}, i);
//
//                         function s(e, t) {
...
//                             e = o[0];
//                             var i = (r = this.interpolate(r, a)).match(/'/g), s = r.match(/"/g);
...
//                                 return r.format(e, t, i.lng, Y(Y({}, i), {}, {interpolationkey: n[1].trim()}))
...
//                             return new Intl.NumberFormat(t, ee(ee({}, n), {}, {style: "currency"})).format(e)
...
//                     }
//                 }, {
//                     key: "format", value: function (e, t, n, o) {
//                         var r = this;
...
//                             }(t), a = i.formatName, s = i.formatOptions;
//                             if (r.formats[a]) {
//                                 var u = e;
//                                 try {
...
//                         this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t) ? this.logger.warn('did not save key "'.concat(n, '" as the namespace "').concat(t, '" was not yet loaded'), "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!") : null != n && "" !== n && (this.backend && this.backend.create && this.backend.create(e, t, n, o, null, oe(oe({}, i), {}, {isUpdate: r})), e && e[0] && this.store.addResource(e[0], t, n, o))
//                     }
//                 }]), i
//             }(b);
//
...
//                     if (t(this, u), e = i.call(this), N && b.call(s(e)), e.options = ae(n), e.services = {}, e.logger = m, e.modules = {external: []}, le(s(e)), o && !e.isInitialized && !n.isClone) {
...
//                             }), !i || this.options.interpolation.format && this.options.interpolation.format !== o.interpolation.format || (s.formatter = r(i), s.formatter.init(s, this.options), this.options.interpolation.format = s.formatter.format.bind(s.formatter)), s.interpolator = new Q(this.options), s.utils = {hasLoadedNamespace: this.hasLoadedNamespace.bind(this)}, s.backendConnector = new re(r(this.modules.backend), s.resourceStore, s, this.options), s.backendConnector.on("*", (function (t) {
...
//                         var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ce, o = n,
...
//                     }
//                 }, {
//                     key: "getFixedT", value: function (t, n, o) {
...
//                             o = ue(ue(ue({}, this.options), t), {isClone: !0}), r = new u(o);
//                         void 0 === t.debug && void 0 === t.prefix || (r.logger = r.logger.clone(t));
//                         var i = ["store", "services", "language"];
//                         return i.forEach((function (t) {
//                             r[t] = e[t]
//                         })), r.services = ue({}, this.services), r.services.utils = {hasLoadedNamespace: r.hasLoadedNamespace.bind(r)}, r.translator = new H(r.services, r.options), r.translator.on("*", (function (e) {
//                             for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
//                             r.emit.apply(r, [e].concat(n))
//                         })), r.init(o, n), r.translator.options = r.options, r.translator.backendConnector.services.utils = {hasLoadedNamespace: r.hasLoadedNamespace.bind(r)}, r
//                     }
//                 }, {
//                     key: "toJSON", value: function () {
//                         return {
...
//             }
//
//             var ge = [], ye = ge.forEach, ve = ge.slice;
//
//             function me(e) {
...
//                     })).catch(n)
//                 })).catch(n)
//             }, Re = !1, Ee = function (e, t, n, o) {
//                 return "function" == typeof n && (o = n, n = void 0), o = o || function () {
//                 }, we ? function (e, t, n, o) {
...
//                     var i = "function" == typeof e.requestOptions ? e.requestOptions(n) : e.requestOptions, a = me({
//                         method: n ? "POST" : "GET",
...
//                         if (i = "function" == typeof i ? i() : i) for (var a in i) r.setRequestHeader(a, i[a]);
...
//                     }
//                 }, {
//                     key: "_readAny", value: function (e, t, n, o, r) {
...
//                             if (!i) return r(null, {});
//                             var s = a.services.interpolator.interpolate(i, {lng: e.join("+"), ns: n.join("+")});
//                             a.loadUrl(s, r, t, o)
//                         }))
//                     }
//                 }, {
//                     key: "loadUrl", value: function (e, t, n, o) {
//                         var r = this;
...
//                     }
//                 }, {
//                     key: "create", value: function (e, t, n, o, r) {
//                         var i = this;
//                         if (this.options.addPath) {
//                             "string" == typeof e && (e = [e]);
//                             var a = this.options.parsePayload(t, n, o), s = 0, u = [], c = [];
//                             e.forEach((function (n) {
//                                 var o = i.options.addPath;
//                                 "function" == typeof i.options.addPath && (o = i.options.addPath(n, t));
//                                 var l = i.services.interpolator.interpolate(o, {lng: n, ns: t});
...
//                         var e = this, t = this.services, n = t.backendConnector, o = t.languageUtils, r = t.logger,
//                             i = n.language;
...
//                         }
//                     }
//                 }], n && Ne(t.prototype, n), Object.defineProperty(t, "prototype", {writable: !1}), e
//             }();
//             De.type = "backend";
//             var Ae = De, Ie = [], Fe = Ie.forEach, Ue = Ie.slice;
//
//             function _e(e) {
...
//             }
//
//             var Be = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, Me = function (e, t, n) {
//                 var o = n || {};
//                 o.path = o.path || "/";
//                 var r = encodeURIComponent(t), i = "".concat(e, "=").concat(r);
//                 if (o.maxAge > 0) {
//                     var a = o.maxAge - 0;
