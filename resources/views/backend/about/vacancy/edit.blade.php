        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <form action="{{ route('backend.about.vacancies.update',$vacancy->id) }}"
                                ...
                                <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="title[{{ $lan->code }}]" type="text"
                                                               class="form-control"
                                                               value="{{ $vacancy->translate($lan->code)->title }}"
                                                               required="">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="education[{{ $lan->code }}]" type="text"
                                                               class="form-control"
                                                               value="{{ $vacancy->translate($lan->code)->education }}"
                                                               required="">
                                                        <div class="valid-feedback">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="experience[{{ $lan->code }}]" type="text"
                                                               class="form-control"
                                                               value="{{ $vacancy->translate($lan->code)->experience }}"
                                                               required="">
                                                        <div class="valid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="age" type="text"
                                               class="form-control" value="{{ $vacancy->age }}" required="">
                                        <div class="valid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="email" type="text"
                                               class="form-control" value="{{ $vacancy->email }}" required="">
                                        <div class="valid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="phone" type="text"
                                               class="form-control" value="{{ $vacancy->phone }}" required="">
                                        <div class="valid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="salary" type="text"
                                               class="form-control" value="{{ $vacancy->salary }}" required="">
                                        <div class="valid-feedback">
