        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.alt-categories.update',$altCategory->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.alt-categories'):
                                                #{{ $altCategory->id }}</h4>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="name[{{ $lan->code }}]" type="text"
                                                               ...
                                                               value="{{ $altCategory->translate($lan->code)->name }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="category" id="category" class="form-control">
                                                @foreach($categories as $category)
                                                    <option @if($altCategory->category_id == $category->id) selected
                                                            @endif
