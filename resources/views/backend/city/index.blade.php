...
@section('title',__('backend.cities'))
@section('styles')
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.cities'):</h4>
                                <a href="{{ route('backend.cities.create')}}" class="btn btn-primary mb-3"><i
                                        class="fas fa-plus"></i>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-primary"
                                           href={{ route('backend.cities.edit',['city'=>$city->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delCity',['id'=>$city->id]) }}">
