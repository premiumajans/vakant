                ...
                <div class="col-xl-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('backend.information.update',auth()->user()->id) }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="mb-3">
                ...
                <div class="col-xl-7 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('backend.information.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                                @csrf
