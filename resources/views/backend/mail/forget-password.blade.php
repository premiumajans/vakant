...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <!-- LOGO -->
    <tr>
        <td bgcolor="#35b8e8" align="center">
            <table
                border="0"
                cellpadding="0"
                cellspacing="0"
    ...
    <tr>
        <td bgcolor="#35b8e8" align="center" style="padding: 0px 10px 0px 10px">
            <table
                border="0"
                cellpadding="0"
                cellspacing="0"
            ...
            >
                ...
                "
                    >
                        <img
                            src="https://i.ibb.co/t8PPV8v/vakant-5.png"
                            width="125"
                            height="120"
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
            ...
            >
                ...
                "
                    >
                        ...
                        <p style="margin: 0;color: black">
                            İstifadəçi şifrənizi dəyişmək üçün linkə daxil olun
                        </p>
                    </td>
                </tr>
                <tr>
                                ...
                                >
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            >
                                                <a
                                                    href="http://localhost:3000/{{ $email }}/{{$reset_token}}"
                                                    target="_blank"
                                                    style="
                                font-size: 20px;
                ...
                "
                    >
                        <p style="margin: 0">
                            <a href="http://localhost:3000/{{ $email }}/{{$reset_token}}" target="_blank" style="color: #35b8e8"
                            >{{http://localhost:3000}}/{{ $email }}/{{$reset_token}}</a
                            >
                        </p>
                    </td>
                </tr>
            ...
            >
                <tr>
                  ...
                  line-height: 25px;">
                        ...
                        <p style="margin: 0">
                            <a href="#contactUS" target="_blank" style="color: #35b8e8"
