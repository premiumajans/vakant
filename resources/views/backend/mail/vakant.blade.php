...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <!-- LOGO -->
    <tr>
        <td bgcolor="#233d4d" align="center">
    ...
    <tr>
        <td bgcolor="#233d4d" align="center" style="padding: 0px 10px 0px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                <tr>
                  ...
                  letter-spacing: 4px;
                  line-height: 48px;">
                        <img src="https://i.ibb.co/7WP4fDS/vakant-3.png" width="125" height="120"
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                ...
                <tr>
                  ...
                  line-height: 25px;
                ">
                        <p style="margin: 0;"><br/>Vakant.az</p>
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                ...
                ">
                        ...
                        <p style="margin: 0">
                            <a href="" target="_blank" style="color: #233d4d"> Daha çox köməyə ehtiyacınız var?</a>
                        </p>
                    </td>
                    <td bgcolor="#FFECD1" align="center" style="
                  padding: 30px 30px 30px 30px;
