                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">@lang('backend.news'): @lang('backend.add-new')</h4>
                                    </div>
                                </div>
                                <form action="{{ route('backend.about.news.store') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="photo"
                                               class="form-control" id="validationCustom" required="">
