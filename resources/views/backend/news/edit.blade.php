                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">@lang('backend.news'): #{{ $news->id }}</h4>
                                    </div>
                                </div>
                                <form action="{{ route('backend.about.news.update',$news->id) }}" method="POST"
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="title[{{ $lan->code }}]"
                                                               class="form-control" id="validationCustom"
                                                              required=""
                                                               value="{!! $news->translate($lan->code)->title !!}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="elm{{$lan->code.$key+1 }}" required=""
                                                                  name="content1[{{$lan->code}}]">{!! $news->translate($lan->code)->content1 !!}</textarea>
                                                        <div class="valid-feedback">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="elm{{$lan->code.$key+2}}" required=""
                                                                  name="content2[{{ $lan->code}}]">{!! $news->translate($lan->code)->content2 !!}</textarea>
                                                        <div class="valid-feedback">
                                                            @lang('backend.content')({{$lan->code}}
                                                            ) @lang('messages.is-correct')
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="elm{{$lan->code.$key+3}}" required=""
                                                                  name="content3[{{$lan->code}}]">{!! $news->translate($lan->code)->content3 !!}</textarea>
                                                        <div class="valid-feedback">
                                                            @lang('backend.content')({{$lan->code}}
                                                            ) @lang('messages.is-correct')
                                                        </div>
