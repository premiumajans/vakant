...
@section('title',__('backend.component'))
@section('content')
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.updateComponentPackage',$packageComponent->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.component'):
                                                #{{ $packageComponent->id }}</h4>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="title[{{ $lan->code }}]" type="text"
                                                               ...
                                                               value="{{ $packageComponent->translate($lan->code)->title ?? '-' }}">
...
{{--                                    <div class="mb-3">--}}
{{--                                        <input name="package_id" type="text"--}}
{{--                                               class="form-control" hidden="" value="{{ $id }}">--}}
{{--                                    </div>--}}
                                </div>
