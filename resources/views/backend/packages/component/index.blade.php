                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            @foreach($packageComponents as $packageComponent)
                                <tr>
                                    ...
                                    @foreach(active_langs() as $lang)
                                        <td class="text-center">{{ $packageComponent->translate($lang->code)->title ?? '-' }}</td>
                                    @endforeach
                                    <td class="text-center">
                                        <a class="btn btn-primary"
                                           href={{ route('backend.editComponentPackages',['id'=>$packageComponent->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delPackageComponent',['id'=>$packageComponent->id]) }}">
