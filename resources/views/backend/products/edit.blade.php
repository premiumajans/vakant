        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.products.update',$product->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <div class="col-12 mb-4">
                                            <label for="category">@lang('backend.photo')</label>
                                        ...
                                        <div class="mb-3" id="altDiv">
                                            ...
                                            <select name="altCategory" id="altCategory" class="form-control">
                                                @foreach($altCategories as $altc)
                                                    <option @if($product->alt_category_id == $altc->id) selected @endif
