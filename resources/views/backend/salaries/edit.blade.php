...
@section('title',__('backend.salary'))
@section('content')
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.salaries.update', $salary->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('backend.salary'): {{ $salary->salary }}₼</h4>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="name[{{ $lan->code }}]" type="text"
                                                               ...
                                                               value="{{ $salary->translate($lan->code)->name }}">
                                    ...
                                    <div class="mb-3">
                                        <label>@lang('backend.salary') <span class="text-danger">*</span></label>
                                        <input name="salary" type="text"
                                               class="form-control" required="" value="{{ $salary->salary }}">
                                        <div class="valid-feedback">
