                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.salary'):</h4>
                                <a href="{{ route('backend.salaries.create')}}" class="btn btn-primary mb-3"><i
                                        class="fas fa-plus"></i>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-primary"
                                           href={{ route('backend.salaries.edit',['salary'=>$salary->id]) }}>
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.delSalary',['id'=>$salary->id]) }}">
