                                        ...
                                        <div class="tab-pane @if($loop->first) active show @endif" id="{{ $lan->code }}" role="tabpanel">
                                            <div class="form-group row">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title[{{ $lan->code }}]" class="form-control" id="validationCustom"  placeholder="@lang('backend.title')">
                                                </div>
                                                <div class="mb-3">
                                                    <label>@lang('backend.description') </label>
                                                    <input type="text" name="description[{{ $lan->code }}]" class="form-control" id="validationCustom"  placeholder="@lang('backend.description')">
                                                </div>
                                                <div class="mb-3">
                                                    <label>@lang('backend.alt') </label>
                                                    <input type="text" name="alt[{{ $lan->code }}]" class="form-control" id="validationCustom"  placeholder="@lang('backend.alt')">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
