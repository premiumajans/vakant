                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.statistics'):</h4>
                                <a href="{{ route('backend.statistics.create') }}" class="btn btn-primary mb-3"><i
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            @foreach($statistics as $statistic)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $statistic->name }}</td>
                                    ...
                                    @canany(['settings edit','settings delete'])
                                        <td class="text-center">
                                            <a class="btn btn-primary"
                                               href={{ route('backend.statistics.edit',['statistic'=>$statistic->id]) }}>
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger"
                                               href="{{ route('backend.delStat',['id'=>$statistic->id]) }}">
