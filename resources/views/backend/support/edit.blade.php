        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="card">
                            <form action="{{ route('backend.support.update',$support->id) }}" class="needs-validation"
                                  novalidate
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">@lang('menus.technical-support'):
                                                #{{ $support->id }}</h4>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="description[{{ $lan->code }}]" type="text"
                                                                  ...
                                                                  placeholder="@lang('backend.description')">{{ $support->translate($lan->code)->description }}</textarea>
